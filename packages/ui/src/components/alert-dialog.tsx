...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      'bg-gray-700/75 backdrop-blur-sm',
      'fixed inset-0 z-[100] overflow-y-auto flex items-end justify-center px-4 pt-4 pb-20 sm:p-0',
...
>((props, ref) => (
  <AlertDialogPrimitive.Title
    ...
    {...props}
  >
    <Typography as={AlertDialogPrimitive.Title} variant='h3'>
      {props.children}
    </Typography>
  </AlertDialogPrimitive.Title>
));
